...
| ตอนได้ชื่อคลิป | ชื่อซ้ำกับแถวอื่นในคิว (ลิงก์ต่างกันแต่เป็นคลิปเดียวกัน) | เอาแถวใหม่ออกจากคิว |
...
- คลิปคนละตัวที่ชื่อเรื่องเหมือนกันเป๊ะ จะไม่เขียนทับไฟล์เดิม (`--no-overwrites`)

## การตั้งค่า

| ตัวเลือก | ค่าเริ่มต้น | ความหมาย |
|---|---|---|
| รูปแบบ | MP4 ตรง | **MP4 ตรง** = เลือกไฟล์ mp4 ที่ชัดที่สุด ไม่ใช้ m3u8 (ถ้าไม่มีจะเลือกแบบอื่นแทน) / **ดีที่สุด** = โหลดภาพกับเสียงแยกกันแล้วรวม (เหมาะกับ YouTube) |
