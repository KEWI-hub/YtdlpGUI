...
- โหลดคลิปเดิมซ้ำ (แม้จะลบไฟล์ไปแล้ว หรือย้ายไปโฟลเดอร์อื่น) จะขึ้น **"มีแล้ว / เคยโหลดแล้ว"** ไม่โหลดซ้ำ
- อยากโหลดใหม่จริงๆ: คลิกขวา → **โหลดซ้ำ** (ไม่เช็คประวัติ และเขียนทับไฟล์เดิม)
- อยากล้างประวัติทั้งหมด: ลบไฟล์ `downloaded.txt` ทิ้ง
...
├── downloaded.txt    ประวัติรหัสคลิปที่โหลดแล้ว ใช้กันโหลดซ้ำ (สร้างเองอัตโนมัติ)
