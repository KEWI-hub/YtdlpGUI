...
เช็คไฟล์ในโฟลเดอร์จาก 2 อย่าง: รหัสคลิปในวงเล็บท้ายชื่อไฟล์ (เช่น `[jNQXAC9IVRw]`) หรือชื่อไฟล์ตรงกับชื่อคลิป (ไม่สนสัญลักษณ์ และยอมให้ชื่อถูกตัดสั้นได้) ใช้กับไฟล์ที่แปลง H.265 แล้วได้ด้วย
